...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			<img src="{{URL::asset('assets/img/brand/logo.jpg')}}" class="error-page" alt="error">
			<h2>Oopps. The page you were looking for doesn't exist</h2>
			<h6>Please Return To The Home Page</h6><a class="btn btn-outline-danger" href="{{ url('/' . $page='home') }}">Back to Home</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
